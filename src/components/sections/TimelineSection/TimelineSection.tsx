...
function TimelineEntry({ item, index }: { item: (typeof timelineItems)[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        <span
          className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full transition-all duration-700 ${
            inView
      ...
      {/* Content card */}
      <div
        className="reveal flex-1 rounded-[18px] border border-[var(--project-panel-border)] bg-[var(--project-panel-bg)] p-4 shadow-[inset_0_1px_0_var(--project-panel-inset)]"
        data-revealed={inView}
