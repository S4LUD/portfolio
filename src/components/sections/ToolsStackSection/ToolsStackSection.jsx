    ...
    <section className={`relative mb-5 rounded-[28px] px-5 max-sm:rounded-[22px] max-sm:px-3 ${contentWidthClass}`}>
      <div className="py-1">
        ...
        <h2 className={`${sectionTitleClass} max-w-[36rem]`}>
          Replace these groups with your exact platforms, service mix, and preferred
          implementation patterns.
        </h2>
      </div>

      <div className="mt-4 grid grid-cols-4 gap-[0.95rem] max-md:grid-cols-2 max-sm:grid-cols-1">
